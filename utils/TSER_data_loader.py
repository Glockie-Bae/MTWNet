...
def TSER_data_loader(dataset_path, dataset_name, norm = "none"):
    train_file = dataset_path + dataset_name + "\\" + dataset_name + "_TRAIN.ts"
    test_file = dataset_path + dataset_name + "\\" + dataset_name +"_TEST.ts"
    ...
    print("[{}] X_train: {}".format(dataset_name, X_train.shape))
    print("[{}] X_test: {}".format(dataset_name, X_test.shape))
    ...
    print("[{}] Finding minimum length".format(dataset_name))
    min_len = np.inf
    ...
    for i in range(len(X_test)):
        ...
        all_len = [len(y) for y in x]
        min_len = min(min(all_len), min_len)
    print("[{}] Minimum length: {}".format(dataset_name, min_len))

    # process the data into numpy array
    print("[{}] Reshaping data".format(dataset_name))
